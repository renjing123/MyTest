...
public class ExcelToImge {
	...
	private static void read() throws Exception {
		InputStream is = new FileInputStream("/Users/mac/Desktop/xinxincode/YqEfJ4.xlsx");
...
//				list.add(m);
				File file = new File("/Users/mac/Desktop/YqEfJ4/" + index + ".png");
				QrCodeUtil.encode(url, file);
			}
