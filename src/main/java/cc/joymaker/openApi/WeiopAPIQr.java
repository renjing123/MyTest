...
//		map.put("pinPasswdLength", 4);
	...
	public static void testCreateQrBatch() throws Exception {
		...
		map.put("productId", "TOFgTDPFnN");
		map.put("size", 100);
		map.put("withPinPasswd", false);
		map.put("name", "云南中烟线上二维码");	//88sKiY
		map.put("orgId", "yunnanzhongyan");
//		map.put("pinPasswdLength", 4);
		map.put("domain", "https://cjiot.cc/");//后来用的是：https://ynzy.tbul.cn/
//		map.put("domain", "http://testcj.tbul.cn/");
	...
	public static void JXcreateQrBatch() throws Exception {
		Map<String, Object> map = new HashMap<>();
			
		map.put("productId", "DFEW7G24SL");
		map.put("size", 300000);
		map.put("withPinPasswd", false);
		map.put("name", "更上一层楼条盒第二批次");	
		map.put("orgId", "jiangxizhongyan");
//		map.put("pinPasswdLength", 4);
		map.put("domain", "https://jxzyh.tbul.cn/");
		map.put("needGenerate", true);
		map.put("operator", "renjing");
